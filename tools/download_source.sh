...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.12.9.tar.xz'
download_file 'http://ftp.gnu.org/gnu/glibc/glibc-2.40.tar.xz'
download_file 'https://github.com/besser82/libxcrypt/releases/download/v4.4.37/libxcrypt-4.4.37.tar.xz'
...
download_file 'https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.2.8.tar.xz'
...
download_file 'https://mirrors.edge.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.12.0.tar.xz'
download_file 'https://github.com/esnet/iperf/releases/download/3.18/iperf-3.18.tar.gz'
download_file 'https://matt.ucc.asn.au/dropbear/releases/dropbear-2024.86.tar.bz2'
