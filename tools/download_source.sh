...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v7.x/linux-7.2.6.tar.xz'
...
download_file 'https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.3.2.tar.xz'
...
download_file 'https://www.netfilter.org/projects/nftables/files/nftables-1.1.7.tar.xz'
