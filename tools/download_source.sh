...
download_file 'https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.3.0.tar.xz'
...
download_file 'https://www.netfilter.org/projects/nftables/files/nftables-1.1.4.tar.xz'
