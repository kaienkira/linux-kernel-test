...
download_file 'https://git.kernel.org/torvalds/t/linux-6.3-rc2.tar.gz'
download_file 'http://ftp.gnu.org/gnu/glibc/glibc-2.37.tar.xz'
download_file 'https://busybox.net/downloads/busybox-1.36.0.tar.bz2'
download_file 'https://www.netfilter.org/projects/libmnl/files/libmnl-1.0.5.tar.bz2'
download_file 'https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.2.4.tar.bz2'
...
download_file 'https://www.netfilter.org/projects/nftables/files/nftables-1.0.6.tar.xz'
download_file 'https://mirrors.edge.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.1.0.tar.xz'
