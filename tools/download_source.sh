...
download_file 'https://git.kernel.org/torvalds/t/linux-6.5-rc7.tar.gz'
...
download_file 'https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.2.6.tar.bz2'
...
download_file 'https://www.netfilter.org/projects/nftables/files/nftables-1.0.8.tar.xz'
download_file 'https://mirrors.edge.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.4.0.tar.xz'
download_file 'https://github.com/esnet/iperf/archive/refs/tags/3.14.tar.gz' 'iperf-3.14.tar.gz'
