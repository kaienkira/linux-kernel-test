...
download_file 'https://mirrors.edge.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.9.0.tar.xz'
download_file 'https://github.com/esnet/iperf/releases/download/3.17.1/iperf-3.17.1.tar.gz'
download_file 'https://matt.ucc.asn.au/dropbear/releases/dropbear-2024.85.tar.bz2'
