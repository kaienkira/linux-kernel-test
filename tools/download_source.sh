...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.13.2.tar.xz'
...
download_file 'https://mirrors.edge.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.13.0.tar.xz'
