...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.8.8.tar.xz'
...
download_file 'https://mirrors.edge.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.8.0.tar.xz'
